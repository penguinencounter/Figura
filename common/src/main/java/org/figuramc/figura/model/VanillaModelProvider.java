...
public enum VanillaModelProvider {
    ...
    CAPE(model -> model instanceof PlayerModelCapeAccessor m ? m.figura$getCloak() : null),
    FAKE_CAPE(model -> model instanceof PlayerModelCapeAccessor m ? m.figura$getFakeCloak() : null),
