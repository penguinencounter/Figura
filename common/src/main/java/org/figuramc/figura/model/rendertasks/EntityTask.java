...
public class EntityTask extends RenderTask {
    ...
    @Override
    public void renderTask(PoseStack stack, MultiBufferSource buffer, int light, int overlay) {
    ...
    public EntityTask setNbt(String nbtOrId, String nullOrNbt) {
        try {
            ...
            if(nullOrNbt == null) {
                ...
                if (!finalNbt.contains("id", NbtType.STRING.getValue())) {
    ...
    public EntityTask updateWalkingDistance(float distance) {
        if(entity != null && entity instanceof LivingEntity) {
            ...
            ((LivingEntityExtension) living).figura$updateWalkAnimation(distance);
        }
        return this;
    }
