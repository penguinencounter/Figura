...
public class FiguraListDocs {
    ...
    private static final Set<String> COLORS = new LinkedHashSet<String>() {{
            ...
            command.executes(context -> {
                ...
                for (Object o : coll) {
                    ...
                    if (o instanceof Map.Entry) {
                        ...
                        component = new TextComponent(o.toString()).withStyle(style -> this == COLORS ? ColorUtils.Colors.valueOf(o.toString()).style : style.withColor(ChatFormatting.WHITE));
                    }
