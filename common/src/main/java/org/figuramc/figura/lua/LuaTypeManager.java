                    ...
                    if (argIndex <= args.narg() && !nil) {
                        try {
                            actualArgs[i] = switch (argumentTypes[i].getName()) {
                                ...
                                case "org.figuramc.luaj.vm2.LuaTable" -> args.checktable(argIndex);
                                case "org.figuramc.luaj.vm2.LuaFunction" -> args.checkfunction(argIndex);
                                case "org.figuramc.luaj.vm2.LuaValue" -> args.arg(argIndex);
        ...
        if (args.arg(argIndex).istable()) {
            ...
            for (int start = argIndex; argIndex <= args.narg(); argIndex++) {
                obj[argIndex - start] = switch (argumentType.getName()) {
                    ...
                    case "[Lorg.figuramc.luaj.vm2.LuaTable;" -> args.checktable(argIndex);
                    case "[Lorg.figuramc.luaj.vm2.LuaFunction;" -> args.checkfunction(argIndex);
                    case "[Lorg.figuramc.luaj.vm2.LuaValue;" -> args.arg(argIndex);
